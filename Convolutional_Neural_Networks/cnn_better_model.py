...
# Path
script_dir = os.path.dirname(__filename__)
...
# Step 1: Convolution
input_size = (128,128) # or 64,64 on a cpu. 128x128 take long time to converge
...
classifier.add(Dropout(0.5)) # drop insignificant nodes
classifier.add(Dense(units=1, activation='sigmoid'))

# Compiling the cnn
classifier.compile(optimizer='adam', loss='binary_crossentropy', etrics = ['accuracy'])
...
# from each epoch i pick rondomly images
...
print("The model indices are: ", training_set.class_indices)
